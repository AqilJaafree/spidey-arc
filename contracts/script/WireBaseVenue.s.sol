...
contract WireBaseVenue is Script {
    ...
    /// Base's CCTP domain, and the Base Sepolia vault capital should mint into.
    ...
    function run() external {
        ...
        address remoteVault = vm.envAddress("BASE_VAULT");
        ...
        bridge.setRoute(VENUE_BASE_UNIV3, DOMAIN_BASE, bytes32(uint256(uint160(remoteVault))));
        ...
        console2.log("venue", VENUE_BASE_UNIV3, "-> Base Sepolia vault", remoteVault);
        console2.log("");
        console2.log("Arc can now bridge INTO Base. The return leg is initiated");
        console2.log("on Base: exit() here reverts by design.");
    }
}
